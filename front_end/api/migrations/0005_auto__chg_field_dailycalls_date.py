...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyCalls.date'
        db.alter_column(u'api_dailycalls', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'DailyCalls.date'
        db.alter_column(u'api_dailycalls', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
