...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'api_apikey', 'key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))

    def backwards(self, orm):

        # Changing field 'ApiKey.key'
        db.alter_column(u'api_apikey', 'key', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
