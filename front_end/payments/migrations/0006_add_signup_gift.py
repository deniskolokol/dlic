...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user in orm['web.ApiUser'].objects.exclude(id__in=orm['payments.Gift'].objects.values_list('user_id', flat=True)):
            orm['payments.Gift'].objects.create(user=user, minutes=settings.SIGNUP_MINUTES, description='Sign up minutes')
            user.seconds_paid = models.F('seconds_paid') + 60 * 60
            user.save()
    ...
    models = {
        ...
        u'payments.gift': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'minutes': ('django.db.models.fields.IntegerField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.ApiUser']", 'null': 'True'})
        },
        u'web.apiuser': {
