...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.card_exp_month'
        db.add_column(u'payments_customer', 'card_exp_month',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Customer.card_exp_year'
        db.add_column(u'payments_customer', 'card_exp_year',
                      self.gf('django.db.models.fields.IntegerField')(default=2012),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.card_exp_month'
        db.delete_column(u'payments_customer', 'card_exp_month')

        # Deleting field 'Customer.card_exp_year'
        db.delete_column(u'payments_customer', 'card_exp_year')
