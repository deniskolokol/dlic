...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Gift'
        db.create_table(u'payments_gift', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.ApiUser'], null=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('minutes', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'payments', ['Gift'])


    def backwards(self, orm):
        # Deleting model 'Gift'
        db.delete_table(u'payments_gift')
