...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFile.bucket'
        db.add_column(u'web_userfile', 'bucket',
                      self.gf('django.db.models.fields.CharField')(default='ersatz1dat', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserFile.bucket'
        db.delete_column(u'web_userfile', 'bucket')
