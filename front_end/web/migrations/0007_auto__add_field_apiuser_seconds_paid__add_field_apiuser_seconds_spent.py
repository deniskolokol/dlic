...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApiUser.seconds_paid'
        db.add_column(u'web_apiuser', 'seconds_paid',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ApiUser.seconds_spent'
        db.add_column(u'web_apiuser', 'seconds_spent',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApiUser.seconds_paid'
        db.delete_column(u'web_apiuser', 'seconds_paid')

        # Deleting field 'ApiUser.seconds_spent'
        db.delete_column(u'web_apiuser', 'seconds_spent')
