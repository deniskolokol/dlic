...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApiUser.date_joined'
        db.add_column(u'web_apiuser', 'date_joined',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApiUser.date_joined'
        db.delete_column(u'web_apiuser', 'date_joined')
