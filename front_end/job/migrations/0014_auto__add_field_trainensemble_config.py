...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.config'
        db.add_column(u'job_trainensemble', 'config',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.config'
        db.delete_column(u'job_trainensemble', 'config')
