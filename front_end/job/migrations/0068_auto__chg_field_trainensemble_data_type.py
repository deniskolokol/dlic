...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrainEnsemble.data_type'
        db.alter_column(u'job_trainensemble', 'data_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'TrainEnsemble.data_type'
        db.alter_column(u'job_trainensemble', 'data_type', self.gf('django.db.models.fields.CharField')(default='TIMESERIES', max_length=20))
