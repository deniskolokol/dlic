...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.old_data'
        db.add_column(u'job_trainensemble', 'old_data',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.old_data'
        db.delete_column(u'job_trainensemble', 'old_data')
