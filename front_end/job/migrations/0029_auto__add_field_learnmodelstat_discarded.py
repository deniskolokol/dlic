...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnModelStat.discarded'
        db.add_column(u'job_learnmodelstat', 'discarded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnModelStat.discarded'
        db.delete_column(u'job_learnmodelstat', 'discarded')
