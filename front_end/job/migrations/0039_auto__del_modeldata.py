...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'job_modeldata')


    def backwards(self, orm):
        # Adding model 'ModelData'
        db.create_table(u'job_modeldata', (
            ('data', self.gf('jsonfield.fields.JSONField')()),
            ('statistic', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['job.LearnModelStat'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'job', ['ModelData'])
