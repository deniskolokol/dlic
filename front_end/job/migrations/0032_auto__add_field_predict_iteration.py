...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Predict.iteration'
        db.add_column(u'job_predict', 'iteration',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='predicts', null=True, to=orm['job.LearnModelStat']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Predict.iteration'
        db.delete_column(u'job_predict', 'iteration_id')
    ...
    models = {
        ...
        u'job.predict': {
            ...
            'error': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iteration': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'predicts'", 'null': 'True', 'to': u"orm['job.LearnModelStat']"}),
