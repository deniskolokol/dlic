...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrainEnsemble.state'
        db.alter_column(u'job_trainensemble', 'state', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'TrainEnsemble.state'
        db.alter_column(u'job_trainensemble', 'state', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
