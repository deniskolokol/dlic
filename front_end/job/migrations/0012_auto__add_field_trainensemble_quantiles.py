...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.quantiles'
        db.add_column(u'job_trainensemble', 'quantiles',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.quantiles'
        db.delete_column(u'job_trainensemble', 'quantiles')
