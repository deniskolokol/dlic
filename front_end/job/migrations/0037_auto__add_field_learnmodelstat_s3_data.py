...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnModelStat.s3_data'
        db.add_column(u'job_learnmodelstat', 's3_data',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnModelStat.s3_data'
        db.delete_column(u'job_learnmodelstat', 's3_data')
