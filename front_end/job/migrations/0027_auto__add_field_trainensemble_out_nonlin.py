...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.out_nonlin'
        db.add_column(u'job_trainensemble', 'out_nonlin',
                      self.gf('django.db.models.fields.CharField')(default='SOFTMAX', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.out_nonlin'
        db.delete_column(u'job_trainensemble', 'out_nonlin')
