...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PredictEnsemble'
        db.create_table(u'job_predictensemble', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='predict_ensembles', to=orm['web.ApiUser'])),
        ...
        db.send_create_signal(u'job', ['PredictEnsemble'])

        # Adding model 'Predict'
        db.create_table(u'job_predict', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ensemble', self.gf('django.db.models.fields.related.ForeignKey')(related_name='predicts', to=orm['job.PredictEnsemble'])),
            ('learn_model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='predicts', to=orm['job.LearnModel'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='NEW', max_length=10)),
            ('pre_activation_results', self.gf('jsonfield.fields.JSONField')(null=True)),
            ('results', self.gf('jsonfield.fields.JSONField')(null=True)),
            ('traceback', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('error', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'job', ['Predict'])


    def backwards(self, orm):
        # Deleting model 'PredictEnsemble'
        db.delete_table(u'job_predictensemble')

        # Deleting model 'Predict'
        db.delete_table(u'job_predict')
