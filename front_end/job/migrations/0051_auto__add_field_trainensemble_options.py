...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.options'
        db.add_column(u'job_trainensemble', 'options',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.options'
        db.delete_column(u'job_trainensemble', 'options')
