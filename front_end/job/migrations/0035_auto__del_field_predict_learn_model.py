...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Predict.learn_model'
        db.delete_column(u'job_predict', 'learn_model_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Predict.learn_model'
        raise RuntimeError("Cannot reverse this migration. 'Predict.learn_model' and its values cannot be restored.")
