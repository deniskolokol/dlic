...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnModel.model_params'
        db.add_column(u'job_learnmodel', 'model_params',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnModel.model_params'
        db.delete_column(u'job_learnmodel', 'model_params')
