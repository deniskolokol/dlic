...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrainEnsemble.data_split'
        db.alter_column(u'job_trainensemble', 'data_split', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'TrainEnsemble.out_nonlin'
        db.alter_column(u'job_trainensemble', 'out_nonlin', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'TrainEnsemble.data_split'
        db.alter_column(u'job_trainensemble', 'data_split', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'TrainEnsemble.out_nonlin'
        db.alter_column(u'job_trainensemble', 'out_nonlin', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'job.trainensemble': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'data_split': ('jsonfield.fields.JSONField', [], {'null': 'True'}),
