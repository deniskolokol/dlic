...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnModelStat.iteration'
        db.add_column(u'job_learnmodelstat', 'iteration',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'LearnModelStat.test_accuracy'
        db.add_column(u'job_learnmodelstat', 'test_accuracy',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)

        # Adding field 'LearnModelStat.model_data'
        db.add_column(u'job_learnmodelstat', 'model_data',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)

        # Deleting field 'LearnModel.best'
        db.delete_column(u'job_learnmodel', 'best')

        # Deleting field 'LearnModel.latest'
        db.delete_column(u'job_learnmodel', 'latest')


    def backwards(self, orm):
        # Deleting field 'LearnModelStat.iteration'
        db.delete_column(u'job_learnmodelstat', 'iteration')

        # Deleting field 'LearnModelStat.test_accuracy'
        db.delete_column(u'job_learnmodelstat', 'test_accuracy')

        # Deleting field 'LearnModelStat.model_data'
        db.delete_column(u'job_learnmodelstat', 'model_data')

        # Adding field 'LearnModel.best'
        db.add_column(u'job_learnmodel', 'best',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)

        # Adding field 'LearnModel.latest'
        db.add_column(u'job_learnmodel', 'latest',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'job.learnmodelstat': {
            ...
            'model_data': ('jsonfield.fields.JSONField', [], {}),
