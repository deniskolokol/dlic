...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("data_management", "0021_auto__add_dataset"),
    )

    def forwards(self, orm):
        # Adding field 'TrainEnsemble.train_dataset'
        db.add_column(u'job_trainensemble', 'train_dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ensembles_as_train', null=True, to=orm['data_management.DataSet']),
                      keep_default=False)

        # Adding field 'TrainEnsemble.test_dataset'
        db.add_column(u'job_trainensemble', 'test_dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ensembles_as_test', null=True, to=orm['data_management.DataSet']),
                      keep_default=False)

        # Adding field 'TrainEnsemble.valid_dataset'
        db.add_column(u'job_trainensemble', 'valid_dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ensembles_as_valid', null=True, to=orm['data_management.DataSet']),
                      keep_default=False)

        # Adding field 'PredictEnsemble.dataset'
        db.add_column(u'job_predictensemble', 'dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data_management.DataSet'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.train_dataset'
        db.delete_column(u'job_trainensemble', 'train_dataset_id')

        # Deleting field 'TrainEnsemble.test_dataset'
        db.delete_column(u'job_trainensemble', 'test_dataset_id')

        # Deleting field 'TrainEnsemble.valid_dataset'
        db.delete_column(u'job_trainensemble', 'valid_dataset_id')

        # Deleting field 'PredictEnsemble.dataset'
        db.delete_column(u'job_predictensemble', 'dataset_id')
