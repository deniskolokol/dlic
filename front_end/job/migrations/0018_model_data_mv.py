...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for stat in orm['job.LearnModelStat'].objects.all():
            md = orm['job.ModelData'](statistic=stat, data=stat.model_data)
            md.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for md in orm['job.ModelData'].objects.all():
            stat = md.statistic
            stat.model_data = md.data
            stat.save()
