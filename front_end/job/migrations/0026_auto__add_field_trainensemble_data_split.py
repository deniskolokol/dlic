...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.data_split'
        db.add_column(u'job_trainensemble', 'data_split',
                      self.gf('jsonfield.fields.JSONField')(default=[60, 20, 20]),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.data_split'
        db.delete_column(u'job_trainensemble', 'data_split')
