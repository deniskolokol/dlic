...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Predict.iteration'
        db.alter_column(u'job_predict', 'iteration_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['job.LearnModelStat']))

    def backwards(self, orm):

        # Changing field 'Predict.iteration'
        db.alter_column(u'job_predict', 'iteration_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['job.LearnModelStat']))
