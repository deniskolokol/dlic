...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnModel.training_time'
        db.add_column(u'job_learnmodel', 'training_time',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnModel.training_time'
        db.delete_column(u'job_learnmodel', 'training_time')
