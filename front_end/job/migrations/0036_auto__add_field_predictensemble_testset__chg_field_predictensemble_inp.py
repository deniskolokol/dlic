...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredictEnsemble.testset'
        db.add_column(u'job_predictensemble', 'testset',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'PredictEnsemble.input_data'
        db.alter_column(u'job_predictensemble', 'input_data', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'PredictEnsemble.testset'
        db.delete_column(u'job_predictensemble', 'testset')


        # User chose to not deal with backwards NULL issues for 'PredictEnsemble.input_data'
        raise RuntimeError("Cannot reverse this migration. 'PredictEnsemble.input_data' and its values cannot be restored.")
