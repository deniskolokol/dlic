...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.deleted'
        db.add_column(u'job_trainensemble', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.deleted'
        db.delete_column(u'job_trainensemble', 'deleted')
