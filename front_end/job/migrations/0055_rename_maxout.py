...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for model in orm['job.LearnModel'].objects.filter(model_name="MAXOUT"):
            model.model_name = 'MLP_MAXOUT'
            model.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for model in orm['job.LearnModel'].objects.filter(model_name="MLP_MAXOUT"):
            model.model_name = 'MAXOUT'
            model.save()
