...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredictEnsemble.s3key'
        db.add_column(u'job_predictensemble', 's3key',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredictEnsemble.s3key'
        db.delete_column(u'job_predictensemble', 's3key')
