...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Predict.state'
        db.delete_column(u'job_predict', 'state')

        # Deleting field 'Predict.traceback'
        db.delete_column(u'job_predict', 'traceback')

        # Deleting field 'Predict.updated'
        db.delete_column(u'job_predict', 'updated')

        # Deleting field 'Predict.created'
        db.delete_column(u'job_predict', 'created')

        # Deleting field 'Predict.results'
        db.delete_column(u'job_predict', 'results')

        # Deleting field 'Predict.error'
        db.delete_column(u'job_predict', 'error')

        # Adding field 'PredictEnsemble.state'
        db.add_column(u'job_predictensemble', 'state',
                      self.gf('django.db.models.fields.CharField')(default='NEW', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Predict.state'
        db.add_column(u'job_predict', 'state',
                      self.gf('django.db.models.fields.CharField')(default='NEW', max_length=10),
                      keep_default=False)

        # Adding field 'Predict.traceback'
        db.add_column(u'job_predict', 'traceback',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Predict.updated'
        raise RuntimeError("Cannot reverse this migration. 'Predict.updated' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Predict.created'
        raise RuntimeError("Cannot reverse this migration. 'Predict.created' and its values cannot be restored.")
        # Adding field 'Predict.results'
        db.add_column(u'job_predict', 'results',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)

        # Adding field 'Predict.error'
        db.add_column(u'job_predict', 'error',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PredictEnsemble.state'
        db.delete_column(u'job_predictensemble', 'state')
    ...
    models = {
        ...
        u'job.trainensemble': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'data_split': ('jsonfield.fields.JSONField', [], {'default': '[60, 20, 20]'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'error': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'file_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.UserFile']", 'null': 'True', 'blank': 'True'}),
            'file_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'out_nonlin': ('django.db.models.fields.CharField', [], {'default': "'SOFTMAX'", 'max_length': '20'}),
