...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.send_email_on_change'
        db.add_column(u'job_trainensemble', 'send_email_on_change',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.send_email_on_change'
        db.delete_column(u'job_trainensemble', 'send_email_on_change')
