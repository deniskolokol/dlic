...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.error'
        db.add_column(u'job_trainensemble', 'error',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LearnModel.error'
        db.add_column(u'job_learnmodel', 'error',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.error'
        db.delete_column(u'job_trainensemble', 'error')

        # Deleting field 'LearnModel.error'
        db.delete_column(u'job_learnmodel', 'error')
