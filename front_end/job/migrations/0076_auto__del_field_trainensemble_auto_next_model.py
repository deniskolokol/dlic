...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrainEnsemble.auto_next_model'
        db.delete_column(u'job_trainensemble', 'auto_next_model')


    def backwards(self, orm):
        # Adding field 'TrainEnsemble.auto_next_model'
        db.add_column(u'job_trainensemble', 'auto_next_model',
