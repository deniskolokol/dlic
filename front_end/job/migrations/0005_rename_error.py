...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('job_trainensemble', 'error', 'traceback')
        db.rename_column('job_learnmodel', 'error', 'traceback')

    def backwards(self, orm):
        db.rename_column('job_trainensemble', 'traceback', 'error')
        db.rename_column('job_learnmodel', 'traceback', 'error')
