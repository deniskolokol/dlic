...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnModel.training_logs'
        db.add_column(u'job_learnmodel', 'training_logs',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnModel.training_logs'
        db.delete_column(u'job_learnmodel', 'training_logs')
    ...
    models = {
        ...
        u'job.learnmodel': {
            ...
            'training_logs': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
