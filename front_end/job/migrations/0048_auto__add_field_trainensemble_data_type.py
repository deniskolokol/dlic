...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.data_type'
        db.add_column(u'job_trainensemble', 'data_type',
                      self.gf('django.db.models.fields.CharField')(default='TIMESERIES', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.data_type'
        db.delete_column(u'job_trainensemble', 'data_type')
