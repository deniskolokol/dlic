...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.send_queue_time'
        db.add_column(u'job_trainensemble', 'send_queue_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.send_queue_time'
        db.delete_column(u'job_trainensemble', 'send_queue_time')
