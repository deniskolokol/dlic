...
class Migration(SchemaMigration):
    depends_on = (
        ("data_management", "0004_change_user_file_fk.py"),
    )
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TrainEnsemble.file_id'
        db.delete_column(u'job_trainensemble', 'file_id_id')

        # Deleting field 'TrainEnsemble.valid_dataset'
        db.delete_column(u'job_trainensemble', 'valid_dataset_id')

        # Deleting field 'PredictEnsemble.file_id'
        db.delete_column(u'job_predictensemble', 'file_id_id')


    def backwards(self, orm):
        # Adding field 'TrainEnsemble.test_dataset'
        db.add_column(u'job_trainensemble', 'test_dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='test_datasets', null=True, to=orm['data_management.DataFile'], blank=True),
                      keep_default=False)

        # Adding field 'TrainEnsemble.file_id'
        db.add_column(u'job_trainensemble', 'file_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='train_ensembles', null=True, to=orm['data_management.DataFile'], blank=True),
                      keep_default=False)

        # Adding field 'TrainEnsemble.valid_dataset'
        db.add_column(u'job_trainensemble', 'valid_dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='valid_datasets', null=True, to=orm['data_management.DataFile'], blank=True),
                      keep_default=False)

        # Adding field 'PredictEnsemble.file_id'
        db.add_column(u'job_predictensemble', 'file_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data_management.DataFile'], null=True, blank=True),
                      keep_default=False)
