...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainEnsemble.net_type'
        db.add_column(u'job_trainensemble', 'net_type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainEnsemble.net_type'
        db.delete_column(u'job_trainensemble', 'net_type')
