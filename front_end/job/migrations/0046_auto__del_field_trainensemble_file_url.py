...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrainEnsemble.file_url'
        db.delete_column(u'job_trainensemble', 'file_url')


    def backwards(self, orm):
        # Adding field 'TrainEnsemble.file_url'
        db.add_column(u'job_trainensemble', 'file_url',
