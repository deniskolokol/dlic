...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PredictEnsemble.predicting_time'
        db.add_column(u'job_predictensemble', 'predicting_time',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PredictEnsemble.predicting_time'
        db.delete_column(u'job_predictensemble', 'predicting_time')
