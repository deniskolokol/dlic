...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnModelStat.train_accuracy'
        db.add_column(u'job_learnmodelstat', 'train_accuracy',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnModelStat.train_accuracy'
        db.delete_column(u'job_learnmodelstat', 'train_accuracy')
