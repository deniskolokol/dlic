...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnModel.detailed_results_file'
        db.add_column(u'job_learnmodel', 'detailed_results_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnModel.detailed_results_file'
        db.delete_column(u'job_learnmodel', 'detailed_results_file')
