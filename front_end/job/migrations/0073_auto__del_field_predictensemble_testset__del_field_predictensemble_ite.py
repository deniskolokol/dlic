...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PredictEnsemble.itershash'
        db.delete_column(u'job_predictensemble', 'itershash')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PredictEnsemble.itershash'
        db.add_column(u'job_predictensemble', 'itershash',
