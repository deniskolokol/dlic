...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Predict.pre_activation_results'
        db.delete_column(u'job_predict', 'pre_activation_results')

        # Adding field 'PredictEnsemble.results'
        db.add_column(u'job_predictensemble', 'results',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)

        # Adding field 'PredictEnsemble.queue_key'
        db.add_column(u'job_predictensemble', 'queue_key',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Predict.pre_activation_results'
        db.add_column(u'job_predict', 'pre_activation_results',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)

        # Deleting field 'PredictEnsemble.results'
        db.delete_column(u'job_predictensemble', 'results')

        # Deleting field 'PredictEnsemble.queue_key'
        db.delete_column(u'job_predictensemble', 'queue_key')
