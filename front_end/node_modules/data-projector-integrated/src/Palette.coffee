...
class Palette
   ...
   @BG_STD : new THREE.Color( 0x000000 )
   @BG_INV : new THREE.Color( 0xFFFFFF )
   @AXES_STD: new THREE.Color( 0x606060 )
   @AXES_INV: new THREE.Color( 0xA0A0A0)

   @BACKGROUND : new THREE.Color( 0x000000 ) # used to display and clear background
   @AXES : new THREE.Color( 0x606060 )
   @HIGHLIGHT : new THREE.Color( 0x00CC00 ) # used to highlight selected data points
   @SELECTOR : new THREE.Color( 0xCC0000 ) # color used for the rubber band/box outline
   @BUTTON : new THREE.Color( 0x808080 )  # button normal color
   @BUTTON_SELECTED : new THREE.Color( 0x29A8CD )  # button selected color
