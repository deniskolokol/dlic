...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_management_dataset', (
            ...
            ('data', self.gf('django.db.models.fields.related.ForeignKey')(related_name='datasets', to=orm['data_management.DataFile'])),
            ('key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('filters', self.gf('jsonfield.fields.JSONField')(default=[])),
            ('iscreated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('shared', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('state', self.gf('django.db.models.fields.CharField')(default='READY', max_length=15)),
    ...
    models = {
        ...
        u'data_management.dataset': {
            ...
            'filters': ('jsonfield.fields.JSONField', [], {'default': '[]'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
