...
try:
    from data_management.dmworker import formats
except ImportError:
    pass
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for df in orm['data_management.DataFile'].objects.all():
            if df.state != 5 and df.format == 'IMAGES' and formats.zip_with_batch_v2 not in df.meta['formats']:
                df.format = "UNSUPPORTED"
                df.save()
