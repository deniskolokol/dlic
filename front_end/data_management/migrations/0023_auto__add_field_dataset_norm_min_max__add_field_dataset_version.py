...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSet.norm_min_max'
        db.add_column(u'data_management_dataset', 'norm_min_max',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataSet.version'
        db.add_column(u'data_management_dataset', 'version',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSet.norm_min_max'
        db.delete_column(u'data_management_dataset', 'norm_min_max')

        # Deleting field 'DataSet.version'
        db.delete_column(u'data_management_dataset', 'version')
