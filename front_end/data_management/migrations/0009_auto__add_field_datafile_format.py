...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataFile.format'
        db.add_column(u'data_management_datafile', 'format',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataFile.format'
        db.delete_column(u'data_management_datafile', 'format')
