...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataSet.user'
        db.alter_column(u'data_management_dataset', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['web.ApiUser']))

    def backwards(self, orm):

        # Changing field 'DataSet.user'
        db.alter_column(u'data_management_dataset', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['web.ApiUser']))
