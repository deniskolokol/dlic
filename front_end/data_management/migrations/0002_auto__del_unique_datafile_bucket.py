...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DataFile', fields ['bucket']
        db.delete_unique(u'data_management_datafile', ['bucket'])


    def backwards(self, orm):
        # Adding unique constraint on 'DataFile', fields ['bucket']
        db.create_unique(u'data_management_datafile', ['bucket'])
    ...
    models = {
        ...
        u'data_management.datafile': {
            ...
            'bucket': ('django.db.models.fields.CharField', [], {'default': "'my.s3.bucket'", 'max_length': '255', 'blank': 'True'}),
