...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataFile.batches_format'
        db.add_column(u'data_management_datafile', 'batches_format',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataFile.mrnn_format'
        db.add_column(u'data_management_datafile', 'mrnn_format',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataFile.batches_format'
        db.delete_column(u'data_management_datafile', 'batches_format')

        # Deleting field 'DataFile.mrnn_format'
        db.delete_column(u'data_management_datafile', 'mrnn_format')
    ...
    models = {
        ...
        u'data_management.datafile': {
            ...
            'batches_format': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'mrnn_format': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
