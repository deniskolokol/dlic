...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        if db.backend_name == 'postgres':
            nextid = orm['data_management.DataFile'].objects.aggregate(max=models.Max('id'))['max'] or 0
            nextid += 1
            db.execute("ALTER SEQUENCE data_management_datafile_id_seq restart %s" % (nextid,))
