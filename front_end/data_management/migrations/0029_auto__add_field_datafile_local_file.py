...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataFile.local_file'
        db.add_column(u'data_management_datafile', 'local_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataFile.local_file'
        db.delete_column(u'data_management_datafile', 'local_file')
