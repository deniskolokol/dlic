...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataFile.shared'
        db.add_column(u'data_management_datafile', 'shared',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataFile.shared'
        db.delete_column(u'data_management_datafile', 'shared')
