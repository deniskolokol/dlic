...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataFile.created'
        db.add_column(u'data_management_datafile', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataFile.created'
        db.delete_column(u'data_management_datafile', 'created')
