...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        if db.backend_name != 'sqlite3':
            db.alter_column('job_trainensemble', 'file_id_id', models.ForeignKey(orm['data_management.DataFile'], null=True, blank=True))

            db.delete_foreign_key('job_trainensemble', 'test_dataset_id')
            db.alter_column('job_trainensemble', 'test_dataset_id', models.ForeignKey(orm['data_management.DataFile'], null=True, blank=True))

            db.delete_foreign_key('job_trainensemble', 'valid_dataset_id')
            db.alter_column('job_trainensemble', 'valid_dataset_id', models.ForeignKey(orm['data_management.DataFile'], null=True, blank=True))

            db.delete_foreign_key('job_predictensemble', 'file_id_id')
            db.alter_column('job_predictensemble', 'file_id_id', models.ForeignKey(orm['data_management.DataFile'], null=True, blank=True))
