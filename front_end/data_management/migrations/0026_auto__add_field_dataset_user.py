...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'data_management_dataset', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='datasets', null=True, to=orm['web.ApiUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSet.user'
        db.delete_column(u'data_management_dataset', 'user_id')
    ...
    models = {
        ...
        u'data_management.dataset': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'datasets'", 'null': 'True', 'to': u"orm['web.ApiUser']"}),
