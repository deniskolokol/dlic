...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSet.last_column_is_output'
        db.add_column(u'data_management_dataset', 'last_column_is_output',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSet.last_column_is_output'
        db.delete_column(u'data_management_dataset', 'last_column_is_output')
